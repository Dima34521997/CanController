...
#define CAN_CANID_CONFIG_MAX		0x57F	// Maximum configurable 11 bit CAN-ID (without SDO).
...
// *** CAN_PRIORITY_... - CAN network send data priorities ***

#define CAN_PRIORITY_ECP		1	// Error control protocols priority (min)
#define CAN_PRIORITY_SDO		2	// SDO priority
#define CAN_PRIORITY_PDO		3	// PDO priority
#define CAN_PRIORITY_TIME		4	// Time stamp object priority
#define CAN_PRIORITY_EMCY		5	// Emergency object priority
#define CAN_PRIORITY_SYNC		6	// Synchronisation object priority
#define CAN_PRIORITY_NMT		7	// NMT object priority (max)
...
#define GEN_ERRET_LOGGER_BUSY		-919	// Logger is busy, try to read later
#define GEN_ERRET_NO_LOGEVENT		-918	// NO logger events
#define GEN_ERRET_NO_UPDATED		-911	// NO objects with updated data
#define GEN_ERRET_OUTOFMEM			-910	// Out of memory - no space
